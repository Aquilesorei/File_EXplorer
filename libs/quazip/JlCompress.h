...
public:
    ...
    static QString extractFile(QuaZip &zip, const QString& fileName, QString fileDest);
    ...
    /**
      ...
      \return true if success, false otherwise.
      */
    static bool compressSubDir(QuaZip* parentZip, const QString& dir, const QString& parentDir, bool recursive,
    ...
    /**
      ...
      \return true if success, false otherwise.
      */
    static bool compressFile(const QString& fileCompressed, const QString& file);
    ...
    /**
      ...
      \return true if success, false otherwise.
      */
    static bool compressFiles(const QString& fileCompressed, const QStringList& files);
    ...
    /**
      ...
      \return true if success, false otherwise.
      */
    static bool compressDir(const QString& fileCompressed, const QString& dir = QString(), bool recursive = true);
    /**
    ...
    /**
      ...
      */
    static QString extractFile(const QString& fileCompressed, const QString& fileName, QString fileDest = QString());
    ...
    /**
      ...
      \return The list of the full paths of the files extracted, empty on failure.
      */
    static QStringList extractFiles(const QString& fileCompressed, const QStringList& files, const QString& dir = QString());
    ...
    /**
      ...
      \return The list of the full paths of the files extracted, empty on failure.
      */
    static QStringList extractDir(const QString& fileCompressed, const QString& dir = QString());
    /// Extract a whole archive.
    /**
      \param fileCompressed The name of the archive.
      ...
      \return The list of the full paths of the files extracted, empty on failure.
      */
    static QStringList extractDir(const QString& fileCompressed, QTextCodec* fileNameCodec, const QString& dir = QString());
    /// Get the file list.
    /**
      ...
      */
    static QStringList getFileList(const QString& fileCompressed);
    /// Extract a single file.
    /**
      ...
      \return The list of the full paths of the files extracted, empty on failure.
      */
    static QString extractFile(QIODevice *ioDevice, const QString& fileName, QString fileDest = QString());
    /// Extract a list of files.
    /**
      \param ioDevice pointer to device with compressed data.
      \param files The file list to extract.
      ...
      \return The list of the full paths of the files extracted, empty on failure.
      */
    static QStringList extractFiles(QIODevice *ioDevice, const QStringList& files, const QString& dir = QString());
    /// Extract a whole archive.
    /**
      \param ioDevice pointer to device with compressed data.
      \param dir The directory to extract to, the current directory if
      ...
      \return The list of the full paths of the files extracted, empty on failure.
      */
    static QStringList extractDir(QIODevice *ioDevice, const QString& dir = QString());
    /// Extract a whole archive.
    /**
      \param ioDevice pointer to device with compressed data.
      \param fileNameCodec The codec to use for file names.
      ...
      \return The list of the full paths of the files extracted, empty on failure.
      */
    static QStringList extractDir(QIODevice* ioDevice, QTextCodec* fileNameCodec, const QString& dir = QString());
    /// Get the file list.
    /**
      \return The list of the files in the archive, or, more precisely, the
      list of the entries, including both files and directories if they
    ...
    ///compress files and folders that are in a list
    /**
      \param fileCompressed the zip file name
      \param items : files and folders
      \return true if success
      */

   static bool compressMulti(const QString &zipFile, const QStringList& items ,const QString &dir ,bool  recursive = true);
};
